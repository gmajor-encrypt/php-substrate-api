...
final class StorageKeyTest extends TestCase
{
    ...
    public function testStorageKeyEncode ()
    {
        ...
        $this->assertEquals(
            ...
            StorageKey::encode($this->hasher,"Timestamp", "now", $this->metadata, []));
        ...
        $this->assertEquals(
            ...
            StorageKey::encode($this->hasher,"Staking", "Bonded", $this->metadata, ["0x1c79a5ada2ff0d55aaa65dfeaf0cba667babf312f9bf100444279b34cd769e49"]));
        ...
        $this->assertEquals(
            ...
            StorageKey::encode($this->hasher,"System", "Account", $this->metadata, ["0x1c79a5ada2ff0d55aaa65dfeaf0cba667babf312f9bf100444279b34cd769e49"]));
        ...
        $this->assertEquals(
            ...
            StorageKey::encode($this->hasher,"Staking", "ErasStakers", $this->metadata, ["0x01000000", "0x9094c424429709a324e65c64f151630e6c3700192bba8abd3c8e2218b61c0a7a"]));

        // Invalid module or storage name, like moonbeam authorMapping module
        $this->expectException(\InvalidArgumentException::class);
        StorageKey::encode($this->hasher,"authorMapping", "mappingWithDeposit", $this->metadata);

        // invalid args
        $this->expectException(\InvalidArgumentException::class);
        StorageKey::encode($this->hasher,"Staking", "Ledger", $this->metadata);
    }
}